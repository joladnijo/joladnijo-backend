    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'status',
                    models.CharField(
                        choices=[('requested', 'requested'), ('fulfilled', 'fulfilled'), ('overloaded', 'overloaded')],
                        default='requested',
                        max_length=20,
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='joladnijo.aidcenter'
                    ),
                ),
                (
                    'organization',
                    models.OneToOneField(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='joladnijo.organization'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'aid_center',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='joladnijo.aidcenter'),
                ),
                (
                    'category',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='joladnijo.assetcategory'),
                ),
            ],
            options={
                'abstract': False,
